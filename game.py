...
def get_top_scores():
    ...
    for score in new_score_list:
        print(f"Player {score['player']} had {score['attempts']} attempts. The secret numbe was {score['secret_number']}, wrong guesses were: {score['wrong_guesses']}")
...
def play_game(player):
    ...
    print(secret) # remove this in production
    attempts = 0
    wrong_guesses = []
    while True:
